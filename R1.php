...
Email.send({
    ...
    Subject : "Reset Demo password",
    Body : '<p><div style="height:30px; width:100%; background:green;"></div><span><h2>Demo</h2></span><div style="height:15px; width:100%; background:black;"></div></p><br><p>Hello <?php echo $username; ?>,</p><p><span style="color:orange">Lungas demo site</span> recieved a request to reset your account password. A link has been generated for you to <span style="color:green">reset</span> your password below. Please click on the link below to change your password.</p><p><a href="https://lungademo.herokuapp.com/R2.php?auth=<?php echo $auth; ?>"><button>Password reset link</button></a></p><p>If you did not make this request or need assistance, please send a email to liyandza.magagula@gmail.com and inform us.</p><p>Thank you</p><br><br><p><div style="height:48px; width:100%; background:black;"><p><div><span style="color:white; padding-left:5px; padding-top:15px; margine-bottom:5px;"><small>© 2021 Kahrent Technology Africa (Pty) Ltd All rights reserved.</small></span></div></p></div></p>'              
  });
 }
}
sendemail();
